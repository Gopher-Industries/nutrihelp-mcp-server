...
Note: free ngrok tier shows an interstitial warning page for browser
traffic — shouldn't affect the MCP connector itself, but if the
connection seems to hang, this is a likely cause.
